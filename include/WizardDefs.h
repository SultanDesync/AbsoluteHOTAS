...
inline const MacroTargetOption kShipActionTargets[] = {
    ...
    {"Select / Accept",        "SelectTarget"},
    {"Navigation Up",          "IncreaseSystemPower"},
    {"Navigation Down",        "DecreaseSystemPower"},
    {"Navigation Left",        "PreviousSystem"},
    {"Navigation Right",       "NextSystem"},
