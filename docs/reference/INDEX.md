...
| `ship-button-bindings.md` | The 23 native ship-action bindings, action routes, ownership, and raw-output boundary. |
...
| `control-map-ship-functions.md` | Legacy 4.x `ControlMap_Custom.txt` binary format and vanilla MAIN/ALT ship-function map; named actions no longer use this path in 5.0. |
