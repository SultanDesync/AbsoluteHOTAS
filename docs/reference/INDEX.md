...
| `ship-button-bindings.md` | The complete native ship list, six independent menu bindings, optional flight-control reuse, ownership, and raw-output boundary. |
...
| `control-map-ship-functions.md` | Legacy 4.x `ControlMap_Custom.txt` binary format and vanilla MAIN/ALT ship-function map; native ship and dedicated menu routes bypass this path. |
